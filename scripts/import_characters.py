...
RADICAL_WUXING = {
    # ===== 木 =====
    "75":  ("木", "radical_木", 80),   # 木
    "118": ("木", "radical_竹", 70),   # 竹
    "140": ("木", "radical_艸", 70),   # 艸
    "115": ("木", "radical_禾", 65),   # 禾
    "199": ("木", "radical_麦", 60),
    "200": ("木", "radical_麻", 55),
    # ===== 火 =====
    "86":  ("火", "radical_火", 80),   # 火 / 灬
    "72":  ("火", "radical_日", 70),   # 日
    "61":  ("火", "radical_心", 65),   # 心 / 忄
    "155": ("火", "radical_赤", 65),
    # ===== 土 =====
    "32":  ("土", "radical_土", 80),   # 土
    "46":  ("土", "radical_山", 70),   # 山
    "170": ("土", "radical_阜", 65),   # 阝（左）
    "102": ("土", "radical_田", 65),   # 田
    "112": ("土", "radical_石", 65),   # 石
    "27":  ("土", "radical_厂", 55),
    "53":  ("土", "radical_广", 55),
    "104": ("土", "radical_疒", 50),
    "108": ("土", "radical_皿", 55),
    # ===== 金 =====
    "167": ("金", "radical_金", 80),   # 金 / 钅
    "18":  ("金", "radical_刀", 70),   # 刀 / 刂
    "62":  ("金", "radical_戈", 65),   # 戈
    "69":  ("金", "radical_斤", 65),   # 斤
    "110": ("金", "radical_矛", 60),
    "111": ("金", "radical_矢", 60),
    "96":  ("金", "radical_玉", 65),   # 玉 / 王
    "154": ("金", "radical_贝", 55),   # 貝
    # ===== 水 =====
    "85":  ("水", "radical_水", 80),   # 水 / 氵
    "173": ("水", "radical_雨", 75),   # 雨
    "15":  ("水", "radical_冫", 65),
    "195": ("水", "radical_鱼", 65),   # 魚
    # ===== 其它高频偏旁（按字义近似）=====
    "9":   ("火", "radical_人", 50),
    "30":  ("水", "radical_口", 50),
    "38":  ("水", "radical_女", 55),
